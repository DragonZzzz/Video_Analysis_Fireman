...
def main():
    ...
    checkpoint = torch.load('/home/zhouzhilong/pytorch-video-recognition/run/run_5/models/C3D-ucf101_epoch-199.pth.tar', map_location=lambda storage, loc: storage)
